...
/**
 * Waarom `.plan` zelf geen maat en geen `overflow` heeft.
 *
 * Het planblad is een A4 liggend van rand tot rand: alleen op ware grootte
 * klopt de schaal 1:50. Het krijgt daarom een eigen paginastijl zonder marges
 * (`@page plan`). Zodra het omhullende blok zelf 297 bij 210 mm groot werd
 * gemaakt met `overflow:hidden`, negeerde Chromium die paginastijl. Het blad
 * belandde dan op een gewone pagina met marges, het hele document kromp naar
 * 88,6% en de schaalbalk van 100 mm mat nog 88,6 mm: de bijgeleverde
 * plattegrond was geen 1:50 meer maar ongeveer 1:56, met een lege pagina
 * achteraan.
 *
 * Zonder die maten pakt de paginastijl wel, meet de balk 99,998 mm en past het
 * blad precies op een pagina. De maat hoort dus op de tekening zelf te staan,
 * niet op het blok eromheen.
 */
