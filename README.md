...
Schakel in het ontwerp naar **3D**. Sleep om te draaien, scroll om te zoomen. Geef bovenin een naam en klik **Standpunt bewaren** om het huidige gezichtspunt bij het ontwerp vast te leggen; klik op een bewaarde naam om er weer heen te springen, of op het kruisje ernaast om hem te verwijderen. Bewaar je onder een naam die al bestaat, dan wordt dat standpunt bijgewerkt in plaats van verdubbeld. Standpunten horen bij het ontwerp: ze reizen mee met revisies en varianten, en een collega ziet hetzelfde beeld. Er passen er 24 in een ontwerp. **Beeld opslaan (PNG)** bewaart het beeld zoals het er op dat moment uitziet, met het revisienummer in de bestandsnaam.

Met **Avond tonen** schakel je naar de avondweergave: de zon gaat uit en de armaturen uit je lichtplan gaan aan, met hun eigen kleurtemperatuur, dimstand en bundelhoek. Spots krijgen een doorzichtige kegel die laat zien waar hun licht vandaan komt. Dit is een visuele benadering en **geen lichtberekening**: er komt geen lux uit en geen gelijkmatigheid, net als bij de bundels op het planblad. De felheid is een verhouding tussen de lampen onderling; armaturen zonder opgegeven lichtstroom zijn allemaal even fel. Er worden maximaal acht lampen als lichtbron getekend — meer kan een browser niet vloeiend aan — en staat er meer aan, dan meldt het beeld hoeveel armaturen wel branden maar niet zijn getekend. De lichtstand wordt bij een standpunt bewaard, dus een standpunt kan een dag- of een avondbeeld zijn.

Gekozen materialen kleuren de vlakken in 3D. Dat werkt alleen voor keuzes waarvan de hoeveelheid in dit ontwerp is berekend: een keuze op grondslag **netto vloeroppervlak** kleurt de vloer van die ruimte, **netto wandoppervlak** de muren eromheen. De ingetypte ruimtenaam telt niet mee; de berekening bepaalt het vlak. Vul bij het materiaal een **weergavekleur voor 3D** in — dat is een eigen veld naast de kleurcode van de leverancier, want een RAL- of NCS-code is niet betrouwbaar naar een schermkleur te rekenen. Zonder weergavekleur blijft het vlak neutraal. Alleen de statussen *Gekozen* en *Door klant bevestigd* kleuren; een voorstel niet. Een muur tussen twee ruimtes met verschillende wandafwerking blijft neutraal, net als een ruimte met twee vloerkeuzes. Onderin het beeld staat wat er gekleurd is en wat niet, met de reden erbij.
